...
<div class="span12" style="width:40%; float:right; margin-top:15px;">
            ...
            <div class="span12">
                <div class="row-fluid">
                  ...
                  <a href="<?php echo base_url(); ?>catalog/viewdistricts" class="btn btn-inverse"><span
				...
				?>
                                            <tr class="odd gradeX">
                                              ...
                                              <td><?php
                                                ...
                                                <td class="center"> <a href="<?php echo base_url();?>catalog/editdistrict/<?php echo $row->id.'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5). '/' . $this->uri->segment(6). '/' . $this->uri->segment(7). '/' . $this->uri->segment(8). '/' . $this->uri->segment(9) ;?>" title="Edit District" class="tip"><span class="icon12 icomoon-icon-pencil"></span></a></td>
                                                <td class="center"><a href="#" title="Remove District" class="tip" onClick="linkRef('<?php echo base_url();?>catalog/deletedistrict/<?php echo $row->id.'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5). '/' . $this->uri->segment(6). '/' . $this->uri->segment(7). '/' . $this->uri->segment(8). '/' . $this->uri->segment(9) ; ?>')"><span class="icon12 icomoon-icon-remove"></span></a></td>                 
                                           </tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#country").change(function () {
            ...
            window.location = '<?php echo base_url().'catalog/viewdistricts/' ?>'+id+'<?php echo '/'.$seg_4.'/'.$seg5.'/'.$seg6.'/'.$seg7.'/'.$seg8  ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#state").change(function () {
            ...
            window.location = '<?php echo base_url().'catalog/viewdistricts/'.$seg_3.'/' ; ?>'+id+'<?php echo '/'.$seg5.'/'.$seg6.'/'.$seg7.'/'.$seg8 ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#sort_status").change(function () {
           ...
           window.location = '<?php echo base_url().'catalog/viewdistricts/'.$seg_3.'/'.$seg_4.'/' ; ?>'+id+'<?php echo '/'.$seg6.'/'.$seg7.'/'.$seg8; ?>';
    ...
    $(document).ready(function () {
        ...
        $("#tipue_search_button").click(function () {
            ...
            if ($("#tipue_search_input").val() != '') {
                ...
                window.location = '<?php echo base_url().'catalog/viewdistricts/'.$seg_3.'/'.$seg_4.'/'.$seg5.'/' ; ?>' + total_name+'<?php echo '/'.$seg7.'/'.$seg8; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#region").change(function () {
			...
			window.location = '<?php echo base_url().'catalog/viewdistricts/'.$seg_3.'/'.$seg_4.'/'.$seg5.'/'.$seg6.'/' ; ?>'+id+'<?php echo '/'.$seg8; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#zone").change(function () {
			...
			window.location = '<?php echo base_url().'catalog/viewdistricts/'.$seg_3.'/'.$seg_4.'/'.$seg5.'/'.$seg6.'/'.$seg7.'/' ; ?>'+id;
