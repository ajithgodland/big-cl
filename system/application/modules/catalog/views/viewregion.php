<div class="contentwrapper"><!--Content wrapper-->
    ...
    <div class="form-row row-fluid" style="width:100%; float:right ;">
        ...
        <?php /*?><div class="form-row row-fluid" style="width:40%; float:right ;">
            <div class="span12">
                <div class="row-fluid">
                    <label class="form-label span4" for="checkboxes">Top Search</label>

                    <div class="span8 controls">
                        <select name="select" id="topsearch">
                            <option value="All">All</option>
                            
                            <option value="yes" <?php if($this->uri->segment(6) == 'yes') {  echo 'selected'; }  ?>>Yes</option>
                            <option value="no" <?php if($this->uri->segment(6) == 'no') {  echo 'selected'; }  ?>>No</option>
    ...
    <a href="<?php echo base_url(); ?>catalog/viewregion" class="btn btn-inverse"><span
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="dynamicTable display table table-bordered"
                        ...
                        foreach ($values as $row) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><?php
                                    $country_details = $this->admin_model->GetByRow('tb_country', $row->parent_id, 'id');
                                ...
                                <td ><a
                                        href="<?php echo base_url(); ?>catalog/editregion/<?php echo $row->id . '/' . $this->uri->segment(3) . '/' . $this->uri->segment(4) . '/' . $this->uri->segment(5) . '/' . $this->uri->segment(6) . '/' . $this->uri->segment(7); ?>"
                                        title="Edit Region" class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
                                </td>
                                <td ><a href="#" title="Remove Region" class="tip"
                                                      onClick="linkRef('<?php echo base_url(); ?>catalog/deleteregion/<?php echo $row->id . '/' . $this->uri->segment(3) . '/' . $this->uri->segment(4) . '/' . $this->uri->segment(5) . '/' . $this->uri->segment(6) . '/' . $this->uri->segment(7); ?>')"><span
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#country").change(function () {
            ...
            window.location = '<?php echo base_url() . 'catalog/viewregion/' ?>' + id + '<?php echo '/' . $seg_4 . '/' . $seg5 . '/' . $seg6; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#sort_status").change(function () {
            ...
            window.location = '<?php echo base_url() . 'catalog/viewregion/' . $seg_3 . '/'; ?>' + id + '<?php echo '/' . $seg5 . '/' . $seg6; ?>';
    ...
    $(document).ready(function () {
        ...
        $("#tipue_search_button").click(function () {
            ...
            if ($("#tipue_search_input").val() != '') {
                ...
                window.location = '<?php echo base_url() . 'catalog/viewregion/' . $seg_3 . '/' . $seg_4 . '/'; ?>' + total_name + '<?php echo '/' . $seg6; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#topsearch").change(function () {
            ...
            window.location = '<?php echo base_url() . 'catalog/viewregion/' . $seg_3 . '/' . $seg_4 . '/' . $seg5 . '/'; ?>' + id;
