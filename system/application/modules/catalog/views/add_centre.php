                      ...
                      <div class="span6" style="width:70%; margin-left:15%;">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url().'catalog/addcentre/' ; ?>" method="post" enctype="multipart/form-data" id="form-validate" />
                                    <div class="form-row row-fluid">
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="normal">Centre</label>
...
<script type="application/javascript">
	...
	({
	type: "POST",
	url: "<?php echo base_url().'catalog/addcentre2' ; ?>",
	data: dataString,
	cache: false,
	success: function(html)
	{
	...
	if(html=='yes')
	{
		$(".locationerror").html('This Centre Already Added !..');
	}
	else
	{
