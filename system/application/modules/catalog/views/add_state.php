        ...
        <div class="span6" style="width:70%; margin-left:15%;">
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'catalog/addstate/'; ?>" method="post"
...
<script type="application/javascript">
    ...
    $("#form-validate").validate({
        ...
        submitHandler: function (form) {
            ...
            ({
                type: "POST",
                url: "<?php echo base_url() . 'catalog/addstate2'; ?>",
                data: dataString,
                cache: false,
                success: function (html) {

                    if (html == 'yes') {
                        $(".locationerror").html('This State Already Added !..');
                    }
                    else {
