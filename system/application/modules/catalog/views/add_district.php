        ...
        <div class="span6" style="width:70%; margin-left:15%;">
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'catalog/adddistrict/'; ?>"
                        ...
                        <div class="span12">
                            <div class="row-fluid">
                                ...
                                <div class="span8 controls zonelist">
                                    <select name="zone" id="zone" class="nostyle selectbox2" style="width:100%;"
                                        ...
                                        if (isset($_POST['state'])) {
                                            ...
                                            foreach ($all_zones as $rrow) {
                                                ?>
                                                <option
                                                    value="<?php echo $rrow->id; ?>" <?php if (isset($_POST['zone'])) {
                                                    if ($_POST['zone'] == $rrow->id) {
                                                        echo 'selected';
                                                    }
                                                } ?>><?php echo ucwords($rrow->country); ?></option>
                                                <?php
...
<script type="application/javascript">
    ...
    $("#form-validate").validate({
        ...
        submitHandler: function (form) {
            ...
            ({
                type: "POST",
                url: "<?php echo base_url() . 'catalog/adddistrict2'; ?>",
                data: dataString,
                cache: false,
                success: function (html) {

                    if (html == 'yes') {
                        $(".locationerror").html('This District Already Added !..');
                    }
                    else {
