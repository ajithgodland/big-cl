...
<div class="span12" style="width:40%; float:right; margin-top:15px;">
                                                        ...
                                                        <select name="area" id="area"  class="nostyle selectbox2" style="width:100%;" placeholder="Select Area" required>                                                             
                                                               <option value="All" >--Select--</option>
																...
																$all_area = $this->admin_model->get_locations($cid,'area');
																	...
																	?>
																	<option value="<?php echo $rrow->id; ?>" <?php if($this->uri->segment(10) == $rrow->id) {  echo 'selected'; }  ?> ><?php echo ucwords($rrow->location); ?></option>
																	<?php
            ...
            <div class="span12">
                <div class="row-fluid">
                  ...
                  <a href="<?php echo base_url(); ?>catalog/viewcentres" class="btn btn-inverse"><span
				...
				?>
                                            <tr class="odd gradeX">
                                              ...
                                              <td><?php
												$area_details = $this->admin_model->GetByRow('tb_locations', $row->parent_id, 'id');
												
												echo ucwords($area_details->location) ;
                                              ...
                                              <td><?php
                                                ...
                                                <td class="center"> <a href="<?php echo base_url();?>catalog/editcentre/<?php echo $row->id.'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5). '/' . $this->uri->segment(6). '/' . $this->uri->segment(7). '/' . $this->uri->segment(8). '/' . $this->uri->segment(9). '/' . $this->uri->segment(10). '/' . $this->uri->segment(11). '/' . $this->uri->segment(12) ;?>" title="Edit Centre" class="tip"><span class="icon12 icomoon-icon-pencil"></span></a></td>
                                                <td class="center"><a href="#" title="Remove Centre" class="tip" onClick="linkRef('<?php echo base_url();?>catalog/deletecentre/<?php echo $row->id.'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5). '/' . $this->uri->segment(6). '/' . $this->uri->segment(7). '/' . $this->uri->segment(8). '/' . $this->uri->segment(9). '/' . $this->uri->segment(10). '/' . $this->uri->segment(11). '/' . $this->uri->segment(12) ;?>')"><span class="icon12 icomoon-icon-remove"></span></a></td>                 
                                           </tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#country").change(function () {
            ...
            window.location = '<?php echo base_url().'catalog/viewcentres/' ?>'+id+'<?php echo '/'.$seg_4.'/'.$seg5.'/'.$seg6.'/'.$seg7.'/'.$seg8.'/'.$seg9.'/'.$seg10 ; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#state").change(function () {
            ...
            window.location = '<?php echo base_url().'catalog/viewcentres/'.$seg_3.'/' ; ?>'+id+'<?php echo '/'.$seg5.'/'.$seg6.'/'.$seg7.'/'.$seg8.'/'.$seg9.'/'.$seg10 ; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#sort_status").change(function () {
           ...
           window.location = '<?php echo base_url().'catalog/viewcentres/'.$seg_3.'/'.$seg_4.'/' ; ?>'+id+'<?php echo '/'.$seg6.'/'.$seg7.'/'.$seg8.'/'.$seg9.'/'.$seg10 ; ?>';
    ...
    $(document).ready(function () {
        ...
        $("#tipue_search_button").click(function () {
            ...
            if ($("#tipue_search_input").val() != '') {
                ...
                window.location = '<?php echo base_url().'catalog/viewcentres/'.$seg_3.'/'.$seg_4.'/'.$seg5.'/' ; ?>'+total_name+'<?php echo '/'.$seg7.'/'.$seg8.'/'.$seg9.'/'.$seg10 ; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#district").change(function () {
			...
			window.location = '<?php echo base_url().'catalog/viewcentres/'.$seg_3.'/'.$seg_4.'/'.$seg5.'/'.$seg6.'/' ; ?>'+id+'<?php echo '/'.$seg8.'/'.$seg9.'/'.$seg10 ; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#region").change(function () {
			...
			window.location = '<?php echo base_url().'catalog/viewcentres/'.$seg_3.'/'.$seg_4.'/'.$seg5.'/'.$seg6.'/'.$seg7.'/' ; ?>'+id+'<?php echo '/'.$seg9.'/'.$seg10 ; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#zone").change(function () {
			...
			window.location = '<?php echo base_url().'catalog/viewcentres/'.$seg_3.'/'.$seg_4.'/'.$seg5.'/'.$seg6.'/'.$seg7.'/'.$seg8.'/' ; ?>'+id+'<?php echo '/'.$seg10 ; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#area").change(function () {
			...
			window.location = '<?php echo base_url().'catalog/viewcentres/'.$seg_3.'/'.$seg_4.'/'.$seg5.'/'.$seg6.'/'.$seg7.'/'.$seg8.'/'.$seg9.'/' ; ?>'+id;
