                      ...
                      <div class="span6" style="width:70%; margin-left:15%;">
                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url().'catalog/editcentre/'.$value->id.'/'.$this->uri->segment(4).'/'.$this->uri->segment(5). '/' . $this->uri->segment(6). '/' . $this->uri->segment(7). '/' . $this->uri->segment(8). '/' . $this->uri->segment(9). '/' . $this->uri->segment(10). '/' . $this->uri->segment(11). '/' . $this->uri->segment(12). '/' . $this->uri->segment(13) ; ?>" method="post" enctype="multipart/form-data" />
                                    <div class="form-row row-fluid">
                                        ...
                                        <input type="hidden" name="type" value="centre">
                                                        ...
                                                        <select name="area" id="area"  class="nostyle selectbox2" style="width:100%;" placeholder="Select Area" required>                                                             
                                                               ...
                                                               <?php 
                                                                ...
                                                                foreach ($all_areas as $rrow) {
                                                                    ?>
                                                                    <option value="<?php echo $rrow->id; ?>" <?php if(isset($_POST['area'])) { if($_POST['area'] == $rrow->id) {  echo 'selected'; } } else {  if($value->parent_id 	 == $rrow->id) {  echo 'selected'; }   } ?>><?php echo ucwords($rrow->location); ?></option>
                                                                <?php
