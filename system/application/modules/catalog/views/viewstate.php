<div class="contentwrapper"><!--Content wrapper-->
    ...
    <a href="<?php echo base_url(); ?>catalog/viewstate" class="btn btn-inverse"><span
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="dynamicTable display table table-bordered"
                        ...
                        foreach ($values as $row) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><?php
                                    $region_details = $this->admin_model->GetByRow('tb_country', $row->parent_id, 'id');
                                ...
                                <td>
                                    <a href="<?php echo base_url(); ?>catalog/editstate/<?php echo $row->id . '/' . $this->uri->segment(3) . '/' . $this->uri->segment(4) . '/' . $this->uri->segment(5) . '/' . $this->uri->segment(6) . '/' . $this->uri->segment(7); ?>"
                                       title="Edit State" class="tip"><span
                                            class="icon12 icomoon-icon-pencil"></span></a></td>
                                <td><a href="#" title="Remove State" class="tip"
                                       onClick="linkRef('<?php echo base_url(); ?>catalog/deletestate/<?php echo $row->id . '/' . $this->uri->segment(3) . '/' . $this->uri->segment(4) . '/' . $this->uri->segment(5) . '/' . $this->uri->segment(6) . '/' . $this->uri->segment(7); ?>')"><span
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#country").change(function () {
            ...
            window.location = '<?php echo base_url() . 'catalog/viewstate/' ?>' + id + '<?php echo '/' . $seg_4 . '/' . $seg5 . '/' . $seg6; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#sort_status").change(function () {
            ...
            window.location = '<?php echo base_url() . 'catalog/viewstate/' . $seg_3 . '/'; ?>' + id + '<?php echo '/' . $seg5 . '/' . $seg6; ?>';
    ...
    $(document).ready(function () {
        ...
        $("#tipue_search_button").click(function () {
            ...
            if ($("#tipue_search_input").val() != '') {
                ...
                window.location = '<?php echo base_url() . 'catalog/viewstate/' . $seg_3 . '/' . $seg_4 . '/'; ?>' + total_name + '<?php echo '/' . $seg6; ?>';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#region").change(function () {
            ...
            window.location = '<?php echo base_url() . 'catalog/viewstate/' . $seg_3 . '/' . $seg_4 . '/' . $seg5 . '/'; ?>' + id;
